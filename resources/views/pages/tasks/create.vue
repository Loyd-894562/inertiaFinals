    ...
    <div class="w-[600px] shadow p-4 mx-auto mt-5 bg-blue-400">
        <form @submit.prevent="submit">
            ...
            <div class="w-full px-3">
                        ...
                        <select id="status" name="status"  v-model="form.status" class="appearance-none block w-full bg-gray-200 text-gray-700 border rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white">
